...
export default function Submit() {
  ...
  return (
    <div>
      <Button onClick={handleOpen}>Gönder</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Fade in={open}>
         <Box sx={style} className="shadow-box p-4 rounded-2xl outline-none">
            <div className='flex flex-col'>
                <div className='flex justify-between min-h-[32px] '>
                    ...
                    <button className="text-[#1d9bf0] px-4 text-[14px] font-semibold leading-5 hover:bg-[#1d9bf01a] rounded-full transition-colors">
                        Taslaklar
                    </button>
                </div>
                <div className='flex flex-col pt-4 min-h-[150px] justify-between '>
                ...
                <div className='w-full h-[0.1px] bg-[#71767b] rounded-full mt-2'/>
